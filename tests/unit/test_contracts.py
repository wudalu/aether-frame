...
from aether_frame.contracts import (
    ...
    AgentConfig, ExecutionConfig, StrategyConfig,
    FrameworkType, TaskStatus, ToolStatus, TaskComplexity, ExecutionMode, AgentStatus,
...
class TestADKCompatibility:
    ...
    def test_task_request_adk_conversion(self):
        ...
        knowledge = KnowledgeSource(name="test_kb", source_type="file", location="/test", description="Test KB")
...
class TestComplexMessages:
    ...
    def test_universal_message_with_content_parts(self):
        ...
        message = UniversalMessage(
            role="assistant",
            content=[text_part, function_part]
        )
