...
class AgentManager(AgentManagerInterface):
    ...
    async def get_agent_status(self, agent_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "config": self._agent_configs.get(agent_id, {}).__dict__ if agent_id in self._agent_configs else {},
            "state": agent_state
        }
    ...
    async def _create_domain_agent(self, agent_id: str, agent_config: AgentConfig) -> DomainAgent:
        """Create framework-specific domain agent."""
