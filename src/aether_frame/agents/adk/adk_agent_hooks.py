...
class AdkAgentHooks(AgentHooks):
    ...
    async def _save_session_context(self, agent_request: AgentRequest, result: TaskResult):
    ...
    async def _record_execution_completion(self, agent_request: AgentRequest, result: TaskResult):
        """Record execution completion in ADK observer."""
        if self.observer:
    ...
    async def _record_execution_error(self, agent_request: AgentRequest, error: Exception):
    ...
    async def _update_conversation_history(self, agent_request: AgentRequest, result: TaskResult):
