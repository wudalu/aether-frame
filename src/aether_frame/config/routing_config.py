...
from ..contracts import FrameworkType, TaskComplexity, ExecutionMode
...
class RoutingConfig:
    ...
    framework_capabilities: Dict[FrameworkType, FrameworkCapabilities] = field(default_factory=dict)
    complexity_routing: Dict[TaskComplexity, ComplexityRouting] = field(default_factory=dict)
