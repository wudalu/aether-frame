...
class FrameworkRegistry:
    ...
    def register_adapter(self, framework_type: FrameworkType, adapter: FrameworkAdapter, config: Optional[dict] = None):
        """
    ...
    async def get_adapter(self, framework_type: FrameworkType) -> Optional[FrameworkAdapter]:
        """
